...
<iframe src="https://player.fireside.fm/v3/MLf2ZzhC+IohBNUne?theme=dark" width="100%" height="200" frameborder="0" scrolling="no"></iframe>
...
## Episode links
  ...
  * [Python Sample for Tip of the Week ](https://gist.github.com/dominickm/cf4b019fc098f2c3b10a25bd645ce52b "Python Sample for Tip of the Week") — This is an example of being able to use type hinting on a return < Python 3.10. In 3.10 the from **future** will not be required. This requires Python 3.6+ 
